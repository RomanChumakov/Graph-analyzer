...
export const getRouteMatrix = (matrix, n) => {
    let routeMatrix = matrix;
    for (let i = 2; i < n; i++) {
        routeMatrix = getMatrixSum(routeMatrix, getMatrixNDegree(matrix, i));
    }
    return routeMatrix;
};

export const getEnclosureRouteMatrix = (matrix, n) => {
    let routeMatrix = matrix;
    for (let i = 2; i <= n; i++) {
        routeMatrix = getMatrixSum(routeMatrix, getMatrixNDegree(matrix, i));
    }
